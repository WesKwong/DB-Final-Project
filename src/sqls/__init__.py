...
from .teachers import TeachersTable, TeachersFunc, gender_map, title_map
from .courses import CoursesTable, CoursesFunc, course_type_map
from .papers import PapersTable, PapersFunc, paper_type_map, level_map
